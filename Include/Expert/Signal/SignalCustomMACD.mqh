...
//+------------------------------------------------------------------+
class CSignalCustomMACD : public CExpertSignal
  {
protected:
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CSignalCustomMACD::CSignalCustomMACD(void) : m_period_fast(12),
                                 m_period_slow(24),
                                 m_period_signal(9),
...
//| Destructor                                                       |
//+------------------------------------------------------------------+
CSignalCustomMACD::~CSignalCustomMACD(void)
  {
  }
//+------------------------------------------------------------------+
//| Validation settings protected data.                              |
//+------------------------------------------------------------------+
bool CSignalCustomMACD::ValidationSettings(void)
  {
...
//| Create indicators.                                               |
//+------------------------------------------------------------------+
bool CSignalCustomMACD::InitIndicators(CIndicators *indicators)
  {
...
//+------------------------------------------------------------------+
bool CSignalCustomMACD::InitMACD(CIndicators *indicators)
  {
...
//+------------------------------------------------------------------+
int CSignalCustomMACD::StateMain(int ind)
  {
   int    res=0;
   double var;
//---
...
//+------------------------------------------------------------------+
bool CSignalCustomMACD::ExtState(int ind)
  {
...
//+------------------------------------------------------------------+
bool CSignalCustomMACD::CompareMaps(int map,int count,bool minimax,int start)
  {
...
//+------------------------------------------------------------------+
int CSignalCustomMACD::LongCondition(void)
  {
   int result=0;
   int idx   =StartIndex();
...
//+------------------------------------------------------------------+
int CSignalCustomMACD::ShortCondition(void)
  {
   int result=0;
   int idx   =StartIndex();
//--- check direction of the main line
