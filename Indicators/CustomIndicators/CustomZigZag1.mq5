...
double    HighMapIndexBuffer[];
double    LowMapIndexBuffer[];
...
//--- indicator buffers mapping
   ...
   SetIndexBuffer(3,HighMapIndexBuffer,INDICATOR_CALCULATIONS);
   SetIndexBuffer(4,LowMapIndexBuffer,INDICATOR_CALCULATIONS);
   ...
   if(prev_calculated==0)
     {
      ...
      ArrayInitialize(HighMapIndexBuffer,-1.);
      ArrayInitialize(LowMapIndexBuffer,-1.);
      start=InpDepth;
     }
      ...
      switch(extreme_search)
        {
         case Extremum:
            ...
            if(last_high!=0.0) HighMapIndexBuffer[shift]=shift-last_high_pos;
            if(last_low !=0.0) LowMapIndexBuffer[shift]=shift-last_low_pos;
            break;
         case Peak:
